...
pub(in crate::window) struct WindowWidgets {
    ...
    pub(in crate::window) clipboard_auto_clear_password_row: ActionRow,
    pub(in crate::window) clipboard_auto_clear_password_check: CheckButton,
    pub(in crate::window) clipboard_auto_clear_seconds_row: ActionRow,
    pub(in crate::window) clipboard_auto_clear_seconds_spin: SpinButton,
...
impl WindowWidgets {
    ...
    pub(in crate::window) fn load(builder: &Builder) -> Result<Self, String> {
        ...
        Ok(Self {
            ...
            clipboard_auto_clear_password_row: required!("clipboard_auto_clear_password_row"),
            clipboard_auto_clear_password_check: required!("clipboard_auto_clear_password_check"),
            clipboard_auto_clear_seconds_row: required!("clipboard_auto_clear_seconds_row"),
            clipboard_auto_clear_seconds_spin: required!("clipboard_auto_clear_seconds_spin"),
